...
function executeGit(cwd, args, context) {
...
function executeGitBytes(cwd, args) {
...
function decodeGitText(output, context, stream) {
  try {
...
function requireGitBytes(cwd, args, context) {
  const result = executeGitBytes(cwd, args)
  if (result.status !== 0) {
