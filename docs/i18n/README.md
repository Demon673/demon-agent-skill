...
**In scope**: the root `README.md`, `CONTRIBUTING.md`, and `CONTEXT.md`, every content document under `docs/`, and the active Agent Note lifecycles under `.agents/notes/` (`proposed/`, `implemented/`, `rejected/`).
