...
How to translate between the two sides of a documentation pair in this repo. The pairing contract — equal authority, the source side, the routine-versus-extended workflow — lives in [README.md](README.md); these rules govern how a counterpart is produced or updated. They bind humans and agents equally. Rule levels follow RFC 2119 usage: **MUST** / **MUST NOT** are gate- or review-blocking; **SHOULD** needs a stated reason to deviate; **MAY** is discretionary.
