...
Turn a broad "find things to simplify" request into evidence-backed Agent Notes that remove or collapse surface. It is guidance, not a checklist: prefer a few well-proven candidates over a pile of thin guesses.
...
A strong simplification removes, folds, or demotes something real with clear evidence that the current design costs more than it buys:
