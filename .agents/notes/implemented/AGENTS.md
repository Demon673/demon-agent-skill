...
These Agent Notes describe shipped decisions. Follow the [documentation standard](../../../docs/AGENTS.md) and the [Agent Note format](../README.md#the-file-format).
...
When a shipped note is unlikely to guide future work, archive its complete triplet through [`archive-agent-notes`](../../../skills/agent/archive-agent-notes/SKILL.md) instead of continuing to maintain it.
