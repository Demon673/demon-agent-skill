...
- Use these skills for placement, prose, and review: [doc-standards](.agents/skills/doc-standards/SKILL.md), [prose-standard](skills/agent/prose-standard/SKILL.md), [repo-standards-review](.agents/skills/repo-standards-review/SKILL.md).
